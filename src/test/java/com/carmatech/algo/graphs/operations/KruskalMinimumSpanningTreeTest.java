...
public class KruskalMinimumSpanningTreeTest {
	...
	public void findMinimumSpanningTree() {
		KruskalMinimumSpanningTree kruskal = new KruskalMinimumSpanningTree(createUndirectedWeightedGraph());
		kruskal.findMinimumSpanningTree();

		List<Edge> mst = kruskal.edges();
		List<Edge> expected = Arrays.asList(new Edge(0, 7, 0.16), new Edge(2, 3, 0.17), new Edge(1, 7, 0.19), new Edge(0, 2, 0.26), new Edge(5, 7, 0.28),
